<!--
Usage:
<AccordionItem title="Section Title">Content here</AccordionItem>
Props:
- title: section title
-->
<script setup>
...
<template>
    <div
        ...
        :class="itemClass"
        class="border-secondary-light dark:border-secondary-dark group cursor-pointer rounded-md border duration-200 ease-out"
        v-bind="attributes"
    >
        <button :class="buttonClass" :disabled="disabled">
            <span class="font-bold">{{ title }}</span>
            <svg
                class="h-5 w-5 transform duration-300 ease-out"
