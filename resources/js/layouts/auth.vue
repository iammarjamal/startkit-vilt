    ...
    <AppLayout :title="title" :description="description" :keywords="keywords" :showSplash="false">
        ...
        >
            <div class="w-full max-w-sm">
                <Transition
                    mode="out-in"
                    :enter-active-class="pageTransition.enterActive"
                    :leave-active-class="pageTransition.leaveActive"
                    :enter-from-class="pageTransition.enterFrom"
                    :leave-to-class="pageTransition.leaveTo"
                >
                    <Motion
                        :key="children?.key || 'auth-content'"
        ...
        <div v-else class="flex min-h-screen bg-background">
            <!-- Main Content -->
            <div :class="cn('flex flex-1 items-center justify-center p-8', showSidePanel ? 'md:w-1/2 lg:w-2/5' : 'w-full')">
            ...
            <Motion
                v-if="showSidePanel"
                :initial="sidePanelVariants.initial"
                :animate="sidePanelVariants.animate"
                class="relative hidden overflow-hidden md:flex md:w-1/2 lg:w-3/5"
            >
                <!-- Content overlay -->
                <div class="relative z-10 flex flex-col items-center justify-center p-12 text-white">
                    ...
                    <Motion
                        ...
                        :class="`absolute top-20 ${isRTL ? 'end-20' : 'start-20'} h-4 w-4 rounded-full bg-white/20`"
                    />
                    <Motion
                        :animate="{ y: [0, 15, 0] }"
                        :transition="{
                        ...
                        :class="`absolute bottom-32 ${isRTL ? 'start-16' : 'end-16'} h-6 w-6 rounded-full bg-white/15`"
                    />
                </div>
